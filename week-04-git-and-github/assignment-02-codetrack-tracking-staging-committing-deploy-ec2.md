...
![pwd](./screenshots/W4-SS-A2/W4-A2-SS-1.png).

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![git status](./screenshots/W4-SS-A2/W4-A2-SS-2.png).
...
![ls](./screenshots/W4-SS-A2/W4-A2-SS-3.png).
...
![index  style](./screenshots/W4-SS-A2/W4-A2-SS-4-1.png).
![style](./screenshots/W4-SS-A2/W4-A2-SS-4-2.png).
...
![git status](./screenshots/W4-SS-A2/W4-A2-SS-5.png).
...
![git add](./screenshots/W4-SS-A2/W4-A2-SS-6.png).
...
![git add](./screenshots/W4-SS-A2/W4-A2-SS-7.png).

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![git log](./screenshots/W4-SS-A2/W4-A2-SS-8.png).
...
![updated name and group](./screenshots/W4-SS-A2/W4-A2-SS-9-modified.png).

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![index modified](./screenshots/W4-SS-A2/W4-A2-SS-10.png).

---

#### Screenshot 11 — Output of `git commit`

![index commit](./screenshots/W4-SS-A2/W4-A2-SS-11.png).

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![index log](./screenshots/W4-SS-A2/W4-A2-SS-12.png).

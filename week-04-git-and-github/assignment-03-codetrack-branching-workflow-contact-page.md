...
![alt text](screenshots/Assg3-task01-01.png)
...
![alt text](screenshots/Assg3-task01-02.png)
...
![alt text](screenshots/Assg3-task3-01.png)

---

#### Screenshot 4 — Output of `git commit`

![alt text](screenshots/Assg3-task3-02.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![alt text](screenshots/Assg3-task3-03.png)
...
![alt text](screenshots/Assg3-task4-001.png)

---

#### Screenshot 7 — Output of `git commit`

![alt text](screenshots/Assg3-task401.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![alt text](Assg3-task7-04.png)
